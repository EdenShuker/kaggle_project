...
#    mkdir ml_code/f2v
#fi
#python ml_code/f2v.py ../data/files ../data/train_set.csv f2v/train.f2v
#python ml_code/f2v.py ../data/files ../data/test_set.csv f2v/test.f2v
#
### run model on splitted data
#python ml_code/model.py  -train ../data/train_set.csv f2v/train.f2v -save first.model -test ../data/test_set.csv f2v/test.f2v test.output
#python ml_code/eval_model.py ../data/test_set.csv test.output
